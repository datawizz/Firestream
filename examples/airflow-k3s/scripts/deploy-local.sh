...
#
# Builds the firestream-* images (including our CUSTOM airflow image with the
# baked DAG), SIDE-LOADS them into the cluster's containerd, then
...
#
# Reads project values from ../config.nix. Run from examples/airflow-k3s/.
#
