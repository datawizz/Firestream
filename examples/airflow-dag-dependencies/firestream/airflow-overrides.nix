...
# image-injection overlay. Intentionally sparse — the interesting customization
# in this example is at the IMAGE level (firestream/airflow-image-overrides.nix:
# config.airflow.dagWorkspace), not the chart.
#
...
#     (including our custom airflow image with the baked guest-DAG venv).
