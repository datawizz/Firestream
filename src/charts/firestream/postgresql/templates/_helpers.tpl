...
{{- if contains "bitnami/" .Values.image.repository }}
  [ -f /opt/firestream/postgresql/tmp/.initialized ] || [ -f /firestream/postgresql/.initialized ]
{{- end }}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/firestream/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/firestream/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/firestream/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/firestream/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/firestream/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/firestream/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/firestream/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
