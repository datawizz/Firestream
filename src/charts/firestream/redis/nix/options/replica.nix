          ...
          type = types.nullOr (types.submodule {
            ...
            options = {
              ...
              subPath = mkOption {
                type = types.nullOr types.str;
                default = null;
                description = "Subdirectory of the volume to mount on Redis replicas containers";
              };
              ...
              existingClaim = mkOption {
                type = types.nullOr types.str;
                default = null;
                description = "Use an existing PVC which must be created manually before bound";
              };
            };
          });
        };
