...
in {
  options.airflow.global = mkOption {
    default = null;
        ...
        compatibility = mkOption {
          ...
          type = types.nullOr (types.submodule {
            options = {
              ...
              omitEmptySeLinuxOptions = mkOption {
                type = types.nullOr types.bool;
                default = null;
                description = "If set, omit empty SeLinuxOptions in the securityContext";
              };
            };
          });
        };
