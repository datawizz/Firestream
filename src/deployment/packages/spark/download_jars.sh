...
# Set output directory in user's home directory
output_directory="$HOME/opt/jars"
...
# Optional: Set SPARK_EXTRA_CLASSPATH if needed
# jars=$(find "$output_directory" -name '*.jar' | tr '\n' ':')
