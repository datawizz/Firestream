...
# os.environ['S3_LOCAL_BUCKET_NAME'] = 'rustybull'
# os.environ['S3_LOCAL_ACCESS_KEY_ID'] = 'dWAPcElxxo8TWhHorffi'
# os.environ['S3_LOCAL_SECRET_ACCESS_KEY'] = 'QOz9AR1sVKaRGQAJg1ZecNQvBueAKHuTFzWSPucF'
# os.environ['S3_LOCAL_ENDPOINT_URL'] = 'http://10.0.0.69:9000'
...
def test_connection():
    ...
    object_data = b'0' * 1024 * 1024 # 1 MB of data
    scaler = 1000
    print(f'Uploading {scaler} MB to bucket [{bucket_name}] with key [{object_key}]')
    s3_client.put_object(Bucket=bucket_name, Key=object_key, Body=object_data * scaler)
