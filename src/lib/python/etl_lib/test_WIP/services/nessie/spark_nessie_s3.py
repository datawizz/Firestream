...
os.environ['S3_BUCKET_NAME'] = "fireworks"
os.environ['AWS_PROFILE'] = "default"
os.environ['S3_ENDPOINT_URL'] = "http://minio.default.svc.cluster.local:9000"
os.environ['AWS_ENDPOINT_URL_S3'] = "http://minio.default.svc.cluster.local:9000"
os.environ['S3_DEFAULT_REGION'] = "us-west-2"
...
spark = SparkSession.builder \
    ...
    .config("spark.sql.catalog.nessie.warehouse", F"s3://{os.environ['S3_BUCKET_NAME']}") \
    ...
    .config("spark.sql.catalog.nessie.aws.client.endpoint-override", os.environ['S3_ENDPOINT_URL']) \
    .config("spark.sql.catalog.nessie.aws.client.region", os.environ['S3_DEFAULT_REGION']) \
