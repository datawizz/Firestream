//! The firestream-api-server-db crate contains all code related to database access: entities, migrations, functions for validating and reading and writing data.
...
/// Creates a connection pool to the database specified in the passed [`firestream-api-server-config::DatabaseConfig`]
