# Superset 4.x Python Package Overrides
# Copyright Firestream. MIT License.
#
# This file contains wheel and source build overrides for Superset 4.x dependencies.
...
#
# Note: Superset 4.x uses Python 3.11

{ pkgs, lib }:

let
  # Build Python with common build tools (Python 3.11 for Superset 4.x)
