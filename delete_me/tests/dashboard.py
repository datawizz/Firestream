# Consume messages from Kafka one at a time using the Python implementation of the Confluent and librd kafka packages
# Use those messages to feed a plotly dash update function.
# when the script is ran as main host the dashboard
